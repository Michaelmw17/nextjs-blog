  ...
  return (
    <div className="head">
      ...
      <div className={`max-w-4xl mx-auto mt-16 py-16 px-14 sm:px-6 lg:px-8`}>
        <h1
          className={`font-bold  text-2xl mt-16 md:mt-36 mb:0  md:text-4xl text-center text-gray-800`}
        >
        ...
        <div
          className={`mt-10 flex flex-wrap justify-center items-center w-full mx-auto space-x-2 md:space-x-4`}
        >
          <a href="#projects">
