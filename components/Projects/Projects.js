    ...
    return (<>
        ...
        <div className="lg:flex-row xl:flex justify-center mt-26 md:justify-end ">
            ...
            <h2 className="mt-2 text-2xl font-semibold text-gray-800 dark:text-white md:mt-0 md:text-3xl">JDP Electrical Services</h2>
                ...
                JDP Electrical has been providing Electrical Services throughout Sydney, North Shore Region and surrounding areas for over 30 years
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-200">
                Create a ReactJS Single Page Application with Landing page & Deployed through AWS Web Services.
                Liaised weekly with the client to develop frontend experience.
                Solo developed website from design, deploy & domain transfer.
                </p>
                <div className="mb-14 md:mb-30">
                </div>
